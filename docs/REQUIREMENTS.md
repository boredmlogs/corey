...
This isn't a framework or a platform. It's working software for my specific needs. I use Slack at work, so it supports Slack. I add the integrations I actually want, not every possible integration.
...
When people contribute, they shouldn't add "Telegram support alongside Slack." They should contribute a skill like `/add-telegram` that transforms the codebase. Users fork the repo, run skills to customize, and end up with clean code that does exactly what they need - not a bloated system trying to support everyone's use case simultaneously.
...
- `/convert-to-telegram` - Replace Slack with Telegram entirely
...
- Use existing tools (Slack Bolt SDK, Claude Agent SDK, MCP servers)
- Minimal glue code
...
### Message Routing
- A router listens to Slack events and routes messages based on configuration
...
### Slack
- Using @slack/bolt with Socket Mode (no public URL needed)
- Bot responds to @mentions in channels and DMs
- Messages stored in SQLite, polled by router
- Authentication via bot token + app-level token in .env
...
### Skills
- `/setup` - Install dependencies, authenticate Slack, configure scheduler, start services
...
- **Trigger**: `@Andy` (case insensitive, via Slack @mention)
- **Persona**: Default Claude (no custom personality)
- **Main channel**: Designated Slack channel
