...
Single Node.js process that connects to Slack (Socket Mode), routes messages to Claude Agent SDK running in Docker containers. Each group has isolated filesystem and memory.
